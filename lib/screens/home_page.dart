...
import 'package:issue_listing_app/widgets/search_section.dart';
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.symmetric(
                          vertical:
                              issueProvider.searchList.isEmpty ? 85 : 100),
                      child: Column(
                        children: [
                          ListView.builder(
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Container(
                                margin: EdgeInsets.only(
                                  top: 5,
                                  bottom:
                                      index == issueProvider.issueList.length
                                          ? 10
                                          : 5,
                                  left: 20,
                                  right: 20,
